-- ============================================
-- UPSERT_SHOP_INTEGRATION - Şifreleme ile
-- ============================================
...
BEGIN
  -- Şifre verilmişse şifrele (frontend'den düz metin gelir)
  ...
  IF v_integration.id IS NULL THEN
    -- Yeni entegrasyon oluştur (şifreli)
  ...
  ELSE
    -- Mevcut entegrasyonu güncelle (şifreli)
