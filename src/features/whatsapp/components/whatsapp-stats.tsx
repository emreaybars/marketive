...
import { TrendingUp, Send, CheckCircle2, Sparkles, ArrowUp, ArrowDown, Activity, MousePointerClick } from 'lucide-react'
  ...
  const stats = [
    {
      ...
      change: 0,
      icon: TrendingUp,
      description: 'WhatsApp Marketing ile kazandığınız toplam ek gelir',
      featured: true,
    },
    {
      title: 'Gönderilen',
      value: analytics?.totalSent?.toLocaleString('tr-TR') || '0',
      change: analytics?.changeFromLastWeek || 0,
      icon: Send,
      description: 'Toplam mesaj gönderimi',
    },
    {
      title: 'Okunma',
      value: analytics?.totalRead?.toLocaleString('tr-TR') || '0',
      change: 0,
      icon: CheckCircle2,
      description: 'Mesajları okundu',
    },
    {
      title: 'Tıklama',
      value: analytics?.totalClicked?.toLocaleString('tr-TR') || '0',
      change: 0,
      icon: MousePointerClick,
      description: 'Link tıklamaları',
    },
  ]
