...
import { X, Plus, Store, Settings, Gift, Copy, Wand2, Upload, ArrowRight, Eye, Save, Edit, ArrowUpRight, ArrowUpLeft, ArrowDownRight, ArrowDownLeft, CornerDownLeft } from 'lucide-react'
...
// Widget pozisyon tipi
type WidgetPosition = 'top-right' | 'top-left' | 'middle-right' | 'middle-left' | 'bottom-right' | 'bottom-left'
  ...
  useEffect(() => {
    if (open && wheel) {
      setFormData({
        ...
        widgetPosition: (wheel.widget_settings?.widget_position as WidgetPosition) || 'middle-right',
            ...
            <TabsContent value="widget" className="space-y-5 sm:space-y-7 mt-3">
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="space-y-2 pt-2">
                  <Label className="text-sm font-medium">Widget Pozisyonu</Label>
                  <Select
                    value={formData.widgetPosition}
                    onValueChange={(value) => setFormData({ ...formData, widgetPosition: value as WidgetPosition })}
                  >
