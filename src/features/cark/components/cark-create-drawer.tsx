    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="space-y-4 py-4">
          {/* Store ID bilgisi */}
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-4 border border-blue-200 dark:border-blue-900">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-900 dark:text-blue-100">Store ID</p>
                <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">{storeId}</p>
              </div>
              <Button
                size="sm"
                onClick={handleCopyStoreId}
