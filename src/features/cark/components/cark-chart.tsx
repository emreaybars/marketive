          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/30 p-2 border border-blue-200 dark:border-blue-800">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <Badge variant="secondary" className="font-normal bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700">
                ...
                <span className="font-semibold text-blue-600 dark:text-blue-400">{totalSpins.toLocaleString()}</span>
              </Badge>
              <Badge variant="secondary" className="font-normal bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700">
          ...
          <>
            ...
            <div className="relative overflow-x-auto pb-2">
              ...
              <div className="absolute bottom-0 left-0 right-0 flex justify-end gap-1 px-2 pointer-events-none sm:hidden">
                ...
                <div className="h-1 w-2 rounded-full bg-blue-500/40" />
              </div>
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-slate-500 dark:text-slate-400 pt-4 border-t border-slate-100 dark:border-slate-800">
              <span>En yüksek:</span>
              <span className="font-semibold text-blue-600 dark:text-blue-400">{maxSpins.toLocaleString()}</span>
